...
class RayPPOTrainer:
    ...
    # =========================================================================
    # SDPO: Self-Distillation Methods (from SDPO_original)
    # =========================================================================
    ...
    def _maybe_build_self_distillation_batch(
        ...
        """
        Build teacher batch for SDPO self-distillation.
        
        Returns None if SDPO is not enabled (loss_mode != 'sdpo').
        Otherwise returns (teacher_batch, metrics) where teacher_batch contains:
        - teacher_input_ids: prompt with solution/feedback + original response
        - teacher_attention_mask, teacher_position_ids
        - self_distillation_mask: which samples have teacher signal
        """
