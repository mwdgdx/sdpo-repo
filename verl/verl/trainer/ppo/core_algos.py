...
def compute_self_distillation_loss(
    ...
    """
    Compute the self-distillation loss for SDPO.
    
    This function computes KL divergence between student and teacher distributions,
    with support for:
    - Full logit distillation or token-level distillation
    - Top-k distillation with optional tail probability
